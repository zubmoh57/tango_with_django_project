...
def populate():
    python_pages = [
        {'title': 'Official Python Tutorial', 'url': 'http://docs.python.org/3/tutorial/', 'views': 112},
    ...
    django_pages = [
        ...
        {'title': 'How to Tango with Django', 'url': 'http://www.tangowithdjango.com/', 'views': 1240}
    ]

    other_pages = [
        {'title': 'Bottle', 'url': 'http://bottlepy.org/docs/dev/', 'views': 5},
        {'title': 'Flask', 'url': 'http://flask.pocoo.org', 'views': 9}
    ]
